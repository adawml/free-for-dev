...
//		var searchTotalDiv = document.getElementById(dq_searchTotalDivID);		//searchTotal = 최근,인기검색어 영역
	...
	function dq_setMouseon()
 	...
 	function dq_branAction(branCd){
 		...
 		//카비시(663801), 코드그라피(656501), 커버낫(640701), 이벳필드(642601), 팔렛(656601), 그레이버(656401), 플랙(642101), 로라로라(656602), 세인트페인(656603), 나인(656604), LEE(651001), 엠엠엘지(672601) -> 마하그리드(642001)
        //로얄살루트(003301), 마텔(003401), 시바스리갈(003501), 글렌피딕(003601), 발베니(003602), 몽키숄더(003603), 헨드릭스 진(003604), CAMPUS(013401), REMY MARTIN(023201), 노주노교(024801), 조니워커(039701), 수정방(039702), 마오타이(058201), 카발란(068401), 막탈라(068403), 올드퍼스(068404), 폴존(068405), 람푸르(068406), 골든블루(617301) -> 발렌타인(003201)
 		if(branCd == '057601'){
 		...
 		}else if((branCd == '663801') || (branCd == '656501') || (branCd == '640701') || (branCd == '642601') || (branCd == '656601') || (branCd == '656401') || (branCd == '642101') || (branCd == '656602') || (branCd == '656603') || (branCd == '656604') || (branCd == '651001') || (branCd == '672601')){
 			$(location).attr('href', ctx_curr+"/dm/bran/brand.do?onlnBranCd=642001");
 		}else if((branCd == '003301') || (branCd == '003401') || (branCd == '003501') || (branCd == '003601') || (branCd == '003602') || (branCd == '003603') || (branCd == '003604') || (branCd == '013401') || (branCd == '023201') || (branCd == '024801') || (branCd == '039701') || (branCd == '039702') || (branCd == '058201') || (branCd == '068401') || (branCd == '068403') || (branCd == '068404') || (branCd == '068405') || (branCd == '068406') || (branCd == '617301')){
 			$(location).attr('href', ctx_curr+"/dm/bran/brand.do?onlnBranCd=003201");
 		}else{
